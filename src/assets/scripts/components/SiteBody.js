    ...
    return(
      <React.Fragment>
        ...
        <div id="features" className="page-section page-section--blue">
          <div className="wrapper">
            <h2 className="section-title"><img className="section-title__icon" src="./assets/images/icons/star.svg" /> Our <span className="strong">Features</span></h2>
            ...
            <div className="row row--gutters-large generic-content-container">
              ...
              <div className="row__medium-6">
                ...
                <div className="feature-item">
                  <img className="feature-item__icon" src="./assets/images/icons/rain.svg" />
                  <h3 className="feature-item__title">We&rsquo;ll Watch the Weather</h3>
                  <p className="feature-item__text">Download our app and we&rsquo;ll send you a notice if it&rsquo;s about to rain in the next 20 minutes around your current location. A good rain can be refreshing, but sometimes you just want to stay dry.</p>
                </div>
                
                <div className="feature-item">
                  <img className="feature-item__icon" src="./assets/images/icons/globe.svg" />
              ...
              <div className="row__medium-6">
                <div className="feature-item">
                  <img className="feature-item__icon" src="./assets/images/icons/wifi.svg" />
                ...
                <div className="feature-item">
                  <img className="feature-item__icon" src="./assets/images/icons/fire.svg" />
